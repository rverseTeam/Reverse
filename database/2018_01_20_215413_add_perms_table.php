...
class AddPermsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $schema->create('perms', function (Blueprint $table) {
            ...
            $table->tinyInteger('perm_change_mii')->nullable()->default(null);
            $table->tinyInteger('perm_change_bio')->nullable()->default(null);
            ...
            $table->tinyInteger('perm_posts_close')->nullable()->default(null);
            $table->tinyInteger('perm_posts_create')->nullable()->default(null);
            $table->tinyInteger('perm_posts_draw')->nullable()->default(null);
            $table->tinyInteger('perm_posts_delete')->nullable()->default(null);
            $table->tinyInteger('perm_posts_vote')->nullable()->default(null);
